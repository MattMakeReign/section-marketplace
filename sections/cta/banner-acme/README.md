# Banner — Acme End-to-End Test

A banner section created via the acme-test project to prove the end-to-end remote marketplace loop works. Bold colour band, single CTA.
...
desktop / mobile-stacked. _Add breakpoint notes here._
